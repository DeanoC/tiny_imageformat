...
TIF_CONSTEXPR inline uint32_t TinyImageFormat_BitSizeOfBlock(TinyImageFormat const fmt) {
	switch(fmt) {
		...
		case TinyImageFormat_CLUT_P8A8: return 8;
		default: return 32;
	}
}
...
TIF_CONSTEXPR inline double TinyImageFormat_MaxAtPhysical(TinyImageFormat const fmt, uint32_t const channel) {
	if(TinyImageFormat_IsHomogenous(fmt) || channel == 0) {
		switch(fmt) {
			...
			case TinyImageFormat_CLUT_P4: return 8.000000;
			case TinyImageFormat_CLUT_P4A4: return 8.000000;
			case TinyImageFormat_CLUT_P8: return 8.000000;
			case TinyImageFormat_CLUT_P8A8: return 8.000000;
