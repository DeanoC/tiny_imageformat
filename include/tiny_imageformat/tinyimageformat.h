//Auto generated by formatgen on Aug 19 2019
#pragma once
...
TIF_CONSTEXPR inline bool TinyImageFormat_FetchLogicalPixelsF(TinyImageFormat const fmt, TinyImageFormat_FetchInput * in, uint32_t const width, float* out) {
	switch(fmt) {
		...
		case TinyImageFormat_R8_SINT:
			for(uint32_t w = 0; w < width; ++w) {
				out[0] = ((float)(((uint8_t const *)in->pixel)[0])) - (float)128.00000000;
				out[1] = (float)0.00000000;
				out[2] = (float)0.00000000;
				out[3] = (float)1.00000000;
				out += 4;
		...
		case TinyImageFormat_R8G8_SINT:
			for(uint32_t w = 0; w < width; ++w) {
				out[0] = ((float)(((uint8_t const *)in->pixel)[0])) - (float)128.00000000;
				out[1] = ((float)(((uint8_t const *)in->pixel)[1])) - (float)128.00000000;
				out[2] = (float)0.00000000;
				out[3] = (float)1.00000000;
				out += 4;
				in->pixel = (void const*)(((uint8_t const*)in->pixel) + 2);
		...
		case TinyImageFormat_R16_SINT:
			for(uint32_t w = 0; w < width; ++w) {
				out[0] = ((float)(((uint16_t const *)in->pixel)[0])) - (float)32768.00000000;
				out[1] = (float)0.00000000;
				out[2] = (float)0.00000000;
				out[3] = (float)1.00000000;
				out += 4;
		...
		case TinyImageFormat_R8G8B8_SINT:
			for(uint32_t w = 0; w < width; ++w) {
				out[0] = ((float)(((uint8_t const *)in->pixel)[0])) - (float)128.00000000;
				out[1] = ((float)(((uint8_t const *)in->pixel)[1])) - (float)128.00000000;
				out[2] = ((float)(((uint8_t const *)in->pixel)[2])) - (float)128.00000000;
				out[3] = (float)1.00000000;
				out += 4;
				in->pixel = (void const*)(((uint8_t const*)in->pixel) + 3);
			}
		...
		case TinyImageFormat_B8G8R8_SINT:
			for(uint32_t w = 0; w < width; ++w) {
				out[2] = ((float)(((uint8_t const *)in->pixel)[0])) - (float)128.00000000;
				out[1] = ((float)(((uint8_t const *)in->pixel)[1])) - (float)128.00000000;
				out[0] = ((float)(((uint8_t const *)in->pixel)[2])) - (float)128.00000000;
				out[3] = (float)1.00000000;
				out += 4;
				in->pixel = (void const*)(((uint8_t const*)in->pixel) + 3);
			}
		...
		case TinyImageFormat_R8G8B8A8_SINT:
			for(uint32_t w = 0; w < width; ++w) {
				...
				out[1] = ((float)(((uint8_t const *)in->pixel)[1])) - (float)128.00000000;
				out[2] = ((float)(((uint8_t const *)in->pixel)[2])) - (float)128.00000000;
				out[3] = ((float)(((uint8_t const *)in->pixel)[3])) - (float)128.00000000;
				out += 4;
				in->pixel = (void const*)(((uint8_t const*)in->pixel) + 4);
			}
			return true;
		...
		case TinyImageFormat_R16G16_SINT:
			for(uint32_t w = 0; w < width; ++w) {
				out[0] = ((float)(((uint16_t const *)in->pixel)[0])) - (float)32768.00000000;
				out[1] = ((float)(((uint16_t const *)in->pixel)[1])) - (float)32768.00000000;
				out[2] = (float)0.00000000;
				out[3] = (float)1.00000000;
				out += 4;
				in->pixel = (void const*)(((uint16_t const*)in->pixel) + 2);
		...
		case TinyImageFormat_R32_SINT:
			for(uint32_t w = 0; w < width; ++w) {
				out[0] = (float)((double)(((uint32_t const *)in->pixel)[0]) - (float)2147483648.00000000);
				out[1] = (float)0.00000000;
				out[2] = (float)0.00000000;
				out[3] = (float)1.00000000;
				out += 4;
		...
		case TinyImageFormat_R16G16B16_SINT:
			for(uint32_t w = 0; w < width; ++w) {
				out[0] = ((float)(((uint16_t const *)in->pixel)[0])) - (float)32768.00000000;
				out[1] = ((float)(((uint16_t const *)in->pixel)[1])) - (float)32768.00000000;
				out[2] = ((float)(((uint16_t const *)in->pixel)[2])) - (float)32768.00000000;
				out[3] = (float)1.00000000;
				out += 4;
				in->pixel = (void const*)(((uint16_t const*)in->pixel) + 3);
			}
		...
		case TinyImageFormat_R16G16B16A16_SINT:
			for(uint32_t w = 0; w < width; ++w) {
				...
				out[1] = ((float)(((uint16_t const *)in->pixel)[1])) - (float)32768.00000000;
				out[2] = ((float)(((uint16_t const *)in->pixel)[2])) - (float)32768.00000000;
				out[3] = ((float)(((uint16_t const *)in->pixel)[3])) - (float)32768.00000000;
				out += 4;
				in->pixel = (void const*)(((uint16_t const*)in->pixel) + 4);
			}
			return true;
		...
		case TinyImageFormat_R32G32_SINT:
			for(uint32_t w = 0; w < width; ++w) {
				out[0] = (float)((double)(((uint32_t const *)in->pixel)[0]) - (float)2147483648.00000000);
				out[1] = (float)((double)(((uint32_t const *)in->pixel)[1]) - (float)2147483648.00000000);
				out[2] = (float)0.00000000;
				out[3] = (float)1.00000000;
				out += 4;
				in->pixel = (void const*)(((uint32_t const*)in->pixel) + 2);
		...
		case TinyImageFormat_R32G32B32_SINT:
			for(uint32_t w = 0; w < width; ++w) {
				out[0] = (float)((double)(((uint32_t const *)in->pixel)[0]) - (float)2147483648.00000000);
				out[1] = (float)((double)(((uint32_t const *)in->pixel)[1]) - (float)2147483648.00000000);
				out[2] = (float)((double)(((uint32_t const *)in->pixel)[2]) - (float)2147483648.00000000);
				out[3] = (float)1.00000000;
				out += 4;
				in->pixel = (void const*)(((uint32_t const*)in->pixel) + 3);
			}
		...
		case TinyImageFormat_R32G32B32A32_SINT:
			for(uint32_t w = 0; w < width; ++w) {
				...
				out[1] = (float)((double)(((uint32_t const *)in->pixel)[1]) - (float)2147483648.00000000);
				out[2] = (float)((double)(((uint32_t const *)in->pixel)[2]) - (float)2147483648.00000000);
				out[3] = (float)((double)(((uint32_t const *)in->pixel)[3]) - (float)2147483648.00000000);
				out += 4;
				in->pixel = (void const*)(((uint32_t const*)in->pixel) + 4);
			}
			return true;
...
TIF_CONSTEXPR inline bool TinyImageFormat_CanFetchLogicalPixelsD(TinyImageFormat const fmt) {
	switch(fmt) {
		...
		case TinyImageFormat_R64G64B64A64_SINT: return true;
		case TinyImageFormat_R64G64B64A64_SFLOAT: return true;
		default: return TinyImageFormat_CanFetchLogicalPixelsF(fmt);
	}
}
...
TIF_CONSTEXPR inline bool TinyImageFormat_FetchLogicalPixelsD(TinyImageFormat const fmt, TinyImageFormat_FetchInput * in, uint32_t const width, double* out) {
	switch(fmt) {
		...
		case TinyImageFormat_R64_SINT:
			for(uint32_t w = 0; w < width; ++w) {
				out[0] = ((double)(((uint64_t const *)in->pixel)[0])) - (double)9223372036854775808.00000000;
				out[1] = (double)0.00000000;
				out[2] = (double)0.00000000;
				out[3] = (double)1.00000000;
				out += 4;
		...
		case TinyImageFormat_R64G64_SINT:
			for(uint32_t w = 0; w < width; ++w) {
				out[0] = ((double)(((uint64_t const *)in->pixel)[0])) - (double)9223372036854775808.00000000;
				out[1] = ((double)(((uint64_t const *)in->pixel)[1])) - (double)9223372036854775808.00000000;
				out[2] = (double)0.00000000;
				out[3] = (double)1.00000000;
				out += 4;
				in->pixel = (void const*)(((uint64_t const*)in->pixel) + 2);
		...
		case TinyImageFormat_R64G64B64_SINT:
			for(uint32_t w = 0; w < width; ++w) {
				out[0] = ((double)(((uint64_t const *)in->pixel)[0])) - (double)9223372036854775808.00000000;
				out[1] = ((double)(((uint64_t const *)in->pixel)[1])) - (double)9223372036854775808.00000000;
				out[2] = ((double)(((uint64_t const *)in->pixel)[2])) - (double)9223372036854775808.00000000;
				out[3] = (double)1.00000000;
				out += 4;
				in->pixel = (void const*)(((uint64_t const*)in->pixel) + 3);
			}
		...
		case TinyImageFormat_R64G64B64A64_SINT:
			for(uint32_t w = 0; w < width; ++w) {
				...
				out[1] = ((double)(((uint64_t const *)in->pixel)[1])) - (double)9223372036854775808.00000000;
				out[2] = ((double)(((uint64_t const *)in->pixel)[2])) - (double)9223372036854775808.00000000;
				out[3] = ((double)(((uint64_t const *)in->pixel)[3])) - (double)9223372036854775808.00000000;
				out += 4;
				in->pixel = (void const*)(((uint64_t const*)in->pixel) + 4);
			}
			return true;
