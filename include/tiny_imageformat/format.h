...
IF_START_MACRO
  ...
  IF_MOD_MACRO(R8_SRGB)
	...
	IF_MOD_MACRO(A4B4G4R4_UNORM_PACK16)
	IF_MOD_MACRO(X4R4G4B4_UNORM_PACK16)
	IF_MOD_MACRO(X4B4G4R4_UNORM_PACK16)
	...
	IF_MOD_MACRO(R5G5B5X1_UNORM_PACK16)
	IF_MOD_MACRO(B5G5R5X1_UNORM_PACK16)
	IF_MOD_MACRO(A1R5G5B5_UNORM_PACK16)
	IF_MOD_MACRO(A1B5G5R5_UNORM_PACK16)
	IF_MOD_MACRO(X1R5G5B5_UNORM_PACK16)
	IF_MOD_MACRO(X1B5G5R5_UNORM_PACK16)
